...
public class hayMachine : MonoBehaviour
{
   ...
   // Start is called before the first frame update
    ...
    public void IncreaseSpeed(Vector3 speedBoost, float duration = 5f)
    {
        translationSpeed += speedBoost;
        StartCoroutine(ResetSpeedAfterDelay(speedBoost, duration));
    }

    private IEnumerator ResetSpeedAfterDelay(Vector3 speedBoost, float delay)
    {
